...
const clothingCard = document.querySelector("#clothingCard");
const accessoryCard = document.querySelector("#acessoryCard");

const search = document.getElementById('searchBox')
search.addEventListener('keyup', function (e){
  console.log(e.target.value.toLowerCase());
  let searchWord = e.target.value
  var filteredArray = productList.filter(productListFilter)
 ...
 productList.forEach(i => {
   ...
   priceSpan.innerText = productDetails.price;
